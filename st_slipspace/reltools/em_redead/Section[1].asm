...
emTautau____ct:
    ...
    /* 00048E2C: */    bl __unresolved                          [R_PPC_REL24(41, 1, "Enemy____ct")]
    /* 00048E30: */    lis r3,0x0                               [R_PPC_ADDR16_HA(1000, 5, "loc_F2B8")]
    /* 00048E34: */    addi r3,r3,0x0                           [R_PPC_ADDR16_LO(1000, 5, "loc_F2B8")]
...
emTautau____dt:
    ...
    /* 00048F94: */    bl __unresolved                          [R_PPC_REL24(41, 1, "Enemy____dt")]
...
emTautauParamAccesser____ct:
    ...
    /* 00048FDC: */    mr r31,r3
    /* 00048FE0: */    li r4,0x12
    /* 00048FE4: */    bl __unresolved                          [R_PPC_REL24(41, 1, "emExtendParamAccesser____ct")]
    /* 00048FE8: */    lis r3,0x0                               [R_PPC_ADDR16_HA(1000, 5, "loc_F528")]
    /* 00048FEC: */    addi r3,r3,0x0                           [R_PPC_ADDR16_LO(1000, 5, "loc_F528")]
...
loc_49088:
    ...
    /* 00049098: */    lis r3,0x0                               [R_PPC_ADDR16_HA(1000, 4, "loc_1050")]
    /* 0004909C: */    lfd f1,0x0(r3)                           [R_PPC_ADDR16_LO(1000, 4, "loc_1050")]
...
loc_490B4:
    ...
    /* 000490C4: */    lis r3,0x0                               [R_PPC_ADDR16_HA(1000, 4, "loc_1050")]
    /* 000490C8: */    lfd f1,0x0(r3)                           [R_PPC_ADDR16_LO(1000, 4, "loc_1050")]
...
loc_490E0:
    ...
    /* 000490F0: */    lis r3,0x0                               [R_PPC_ADDR16_HA(1000, 4, "loc_1050")]
    /* 000490F4: */    lfd f1,0x0(r3)                           [R_PPC_ADDR16_LO(1000, 4, "loc_1050")]
...
loc_4910C:
    ...
    /* 0004911C: */    lis r3,0x0                               [R_PPC_ADDR16_HA(1000, 4, "loc_1050")]
    /* 00049120: */    lfd f1,0x0(r3)                           [R_PPC_ADDR16_LO(1000, 4, "loc_1050")]
...
loc_49138:
    /* 00049138: */    lis r3,0x0                               [R_PPC_ADDR16_HA(1000, 4, "loc_1048")]
    /* 0004913C: */    lfs f1,0x0(r3)                           [R_PPC_ADDR16_LO(1000, 4, "loc_1048")]
loc_49140:
...
emTautauParamAccesser__getParamIndefinite:
    ...
    /* 00049260: */    lis r4,0x0                               [R_PPC_ADDR16_HA(1000, 5, "loc_F508")]
    /* 00049264: */    addi r4,r4,0x0                           [R_PPC_ADDR16_LO(1000, 5, "loc_F508")]
...
emTautauParamAccesser____dt:
    ...
    /* 000492F8: */    bl __unresolved                          [R_PPC_REL24(41, 1, "emExtendParamAccesser____dt")]
...
emtautauparamaccessercpp____sinit_:
    ...
    /* 00049338: */    lis r31,0x0                              [R_PPC_ADDR16_HA(1000, 6, "loc_574")]
    /* 0004933C: */    addi r3,r31,0x0                          [R_PPC_ADDR16_LO(1000, 6, "loc_574")]
    /* 00049340: */    bl emTautauParamAccesser____ct
    /* 00049344: */    addi r3,r31,0x0                          [R_PPC_ADDR16_LO(1000, 6, "loc_574")]
    /* 00049348: */    lis r4,0x0                               [R_PPC_ADDR16_HA(1000, 1, "emTautauParamAccesser____dt")]
    /* 0004934C: */    addi r4,r4,0x0                           [R_PPC_ADDR16_LO(1000, 1, "emTautauParamAccesser____dt")]
    /* 00049350: */    lis r5,0x0                               [R_PPC_ADDR16_HA(1000, 6, "loc_568")]
    /* 00049354: */    addi r5,r5,0x0                           [R_PPC_ADDR16_LO(1000, 6, "loc_568")]
    /* 00049358: */    bl __unresolved                          [R_PPC_REL24(1000, 1, "globaldestructorchain____register_global_object")]
...
/*Due their similiar coding, I am unsure which is which*/
    ...
    /* 0003C5C0: */    mr r3,r31
    /* 0003C5C4: */    li r4,0x0
    /* 0003C5C8: */    bl __unresolved                          [R_PPC_REL24(41, 1, "Enemy__initRot")]
...
/*Comment: This should be the "Grab release" section. Same note as before*/
    ...
    /* 0003C650: */    mr r3,r31
    /* 0003C654: */    li r4,0x0
    /* 0003C658: */    bl __unresolved                          [R_PPC_REL24(41, 1, "Enemy__initRot")]
...
loc_buc3C680:
    ...
    /* 0003C68C: */    mr r6,r29
    /* 0003C690: */    mr r7,r30
    /* 0003C694: */    bl __unresolved                          [R_PPC_REL24(41, 1, "Enemy__notifyEventLink")]
loc_buc3C698:
...
/*Comment: Not sure what this does, but it checks the "Throw" action. Same as NotifyEventLink*/
    ...
    /* 0003C700: */    lis r3,0x0                               [R_PPC_ADDR16_HA(1000, 4, "loc_bucEF0")] /*Constant is set at 0, which Bucyulus has*/
    /* 0003C704: */    lfs f0,0x0(r3)                           [R_PPC_ADDR16_LO(1000, 4, "loc_bucEF0")]
...
/*Comment: Checks the float of 4006 parameter (I think its LA-Float 4006). Might differ between Towtow & Bucyulus */
    ...
    /* 0003C728: */    lis r3,0x0                               [R_PPC_ADDR16_HA(1000, 4, "loc_bucEF4")] /*Constant is set at 1 in float, which Bucyulus has*/
    /* 0003C72C: */    lfs f0,0x0(r3)                           [R_PPC_ADDR16_LO(1000, 4, "loc_bucEF4")]
...
loc_buc3C770:
    /* 0003C770: */    bl __unresolved                          [R_PPC_REL24(41, 1, "Enemy__notifyEventChangeStatus")]
loc_buc3C774:
...
__entry:
    ...
    /* 0006B770: */    lis r31,0x0                              [R_PPC_ADDR16_HA(1000, 2, "loc_0")]
    /* 0006B774: */    addi r31,r31,0x0                         [R_PPC_ADDR16_LO(1000, 2, "loc_0")]
...
__exit:
    ...
    /* 0006B7B8: */    lis r31,0x0                              [R_PPC_ADDR16_HA(1000, 3, "loc_0")]
    /* 0006B7BC: */    addi r31,r31,0x0                         [R_PPC_ADDR16_LO(1000, 3, "loc_0")]
...
globaldestructorchain____register_global_object:
    /* 00000000: */    lis r6,0x0                               [R_PPC_ADDR16_HA(1000, 6, "loc_0")]
    /* 00000004: */    lwz r0,0x0(r6)                           [R_PPC_ADDR16_LO(1000, 6, "loc_0")]
    /* 00000008: */    stw r0,0x0(r5)
    /* 0000000C: */    stw r4,0x4(r5)
    /* 00000010: */    stw r3,0x8(r5)
    /* 00000014: */    stw r5,0x0(r6)                           [R_PPC_ADDR16_LO(1000, 6, "loc_0")]
    /* 00000018: */    blr
globaldestructorchain____destroy_global_chain:
    ...
    /* 0000002C: */    lis r31,0x0                              [R_PPC_ADDR16_HA(1000, 6, "loc_0")]
    /* 00000030: */    b loc_50
loc_34:
    /* 00000034: */    lwz r0,0x0(r3)
    /* 00000038: */    li r4,-0x1
    /* 0000003C: */    stw r0,0x0(r31)                          [R_PPC_ADDR16_LO(1000, 6, "loc_0")]
    /* 00000040: */    lwz r12,0x4(r3)
    /* 00000044: */    lwz r3,0x8(r3)
    /* 00000048: */    mtctr r12
    /* 0000004C: */    bctrl
loc_50:
    /* 00000050: */    lwz r3,0x0(r31)                          [R_PPC_ADDR16_LO(1000, 6, "loc_0")]
