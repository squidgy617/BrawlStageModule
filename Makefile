...
all: st_final.rel st_village.rel st_qbert.rel st_warfactory.rel st_skypillar.rel st_lava.rel st_worldtournament.rel st_smashketball.rel st_kingofthehill.rel st_gimmick.rel st_lunarhorizon.rel st_cheesebridge.rel st_camera.rel
...
st_kingofthehill.rel:
	@cd custom/st_kingofthehill &&

st_gimmick.rel:
	@cd custom/st_gimmick && make

st_lunarhorizon.rel:
	@cd custom/st_lunarhorizon && make

st_cheesebridge.rel:
	@cd custom/st_cheesebridge && make

st_camera.rel:
	@cd demos/st_camera && make
