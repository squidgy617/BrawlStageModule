...
void grAdventureBarrelCannon::startup(gfArchive* archive, u32 unk1, u32 unk2)
{
    ...
    this->areaData = (soAreaData){ 0, 0x15, 0, 0, 0, 0, stageData->cannonAreaOffsetPos.m_x, stageData->cannonAreaOffsetPos.m_y, stageData->cannonAreaRange.m_x, stageData->cannonAreaRange.m_y};
